...
//Refactored Smithy Card with Bug that 
//changes the amount of cards the user draws from 3 to 9
...
//Refactored Mine Card with Bug that
//changes the gained card placement from hand to deck
...
//Refactored Remodel Card with Bug that
//changes the gained card placement from discarded pile to hand
...
//Refactored Village Card WITHOUT Bug 
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  temphand[i] = -1;
    ...
    case mine:
      mineCard(state, handPos, choice1, choice2);
      /*j = state->hand[currentPlayer][choice1];  //store card we will trash
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
  {
    ...
    case remodel:
      remodelCard(state, handPos, choice1, choice2);
      /*j = state->hand[currentPlayer][choice1];  //store card we will trash
